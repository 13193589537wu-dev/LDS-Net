...
from .binary_dataset import BinarySegDataset
...
__all__ = [
    ...
    'ChaseDB1Dataset', 'DRIVEDataset', 'HRFDataset', 'STAREDataset', 'MapillaryDataset', 'CocoStuff','BinarySegDataset','QTPLDataset','SurfaceWaterDataset'
]
